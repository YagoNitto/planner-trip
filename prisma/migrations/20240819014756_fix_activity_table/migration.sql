/*
  ...
  - You are about to drop the column `tile` on the `activities` table. All the data in the column will be lost.
...
INSERT INTO "new_activities" ("id", "occurs_at", "trip_id") SELECT "id", "occurs_at", "trip_id" FROM "activities";
